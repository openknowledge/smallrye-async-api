...
import de.openknowledge.asyncapi.core.runtime.io.definition.DefinitionWriter;
...
public class AsyncApiSerializer {
     ...
     */
    public static final String serialize(AsyncAPI asyncAPI, Format format) throws IOException {
        try {
