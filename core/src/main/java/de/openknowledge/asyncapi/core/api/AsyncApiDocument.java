...
import de.openknowledge.asyncapi.core.api.util.ConfigUtil;
import de.openknowledge.asyncapi.core.api.util.FilterUtil;
...
public class AsyncApiDocument {
    ...
    public String toString() {
        return "AsyncApiDocument{" + "config=" + config + ", annotationsModel=" + annotationsModel + ", readerModel="
                + readerModel
                + ", staticFileModel=" + staticFileModel + ", filters=" + filters + ", archiveName='" + archiveName + '\''
                + ", model=" + model
                + '}';
    }
}
