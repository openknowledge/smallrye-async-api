...
public class AsyncApiProcessor {
    ...
    public static AsyncAPI bootstrap(AsyncApiConfig config, IndexView index, ClassLoader classLoader) {
        List<AsyncApiStaticFile> staticfiles = loadOpenApiStaticFiles(classLoader);
    ...
    private static List<AsyncApiStaticFile> loadOpenApiStaticFiles(ClassLoader classLoader) {
        List<AsyncApiStaticFile> apiStaticFiles = new ArrayList<>();

        loadOpenApiStaticFile(apiStaticFiles, classLoader, "/META-INF/asyncapi.yaml", AsyncApiFormat.YAML);
        loadOpenApiStaticFile(apiStaticFiles, classLoader, "/WEB-INF/classes/META-INF/asyncapi.yaml", AsyncApiFormat.YAML);
        loadOpenApiStaticFile(apiStaticFiles, classLoader, "/META-INF/asyncapi.yml", AsyncApiFormat.YAML);
        loadOpenApiStaticFile(apiStaticFiles, classLoader, "/WEB-INF/classes/META-INF/asyncapi.yml", AsyncApiFormat.YAML);
        loadOpenApiStaticFile(apiStaticFiles, classLoader, "/META-INF/asyncapi.json", AsyncApiFormat.JSON);
        loadOpenApiStaticFile(apiStaticFiles, classLoader, "/WEB-INF/classes/META-INF/asyncapi.json", AsyncApiFormat.JSON);

        return apiStaticFiles;
    }

    private static List<AsyncApiStaticFile> loadOpenApiStaticFile(List<AsyncApiStaticFile> apiStaticFiles,
